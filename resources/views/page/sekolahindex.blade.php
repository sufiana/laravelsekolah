            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <input type="search" id="customSearch" class="form-control form-control-sm w-50"
                            placeholder="Cari...">
                    </div>
...
@section('js')
    ...
    <script>
        ...
        function renderPagination(total, current) {
            ...
            // Previous button
            if (current > 1) {
                html += `<button class="btn btn-sm btn-outline-primary me-1" onclick="loadCards(${current - 1}, '${searchTerm}')">«</button>`;
            }

            // First page
            if (current > 3) {
                html += `<button class="btn btn-sm btn-outline-primary me-1" onclick="loadCards(1, '${searchTerm}')">1</button>`;
                if (current > 4) {
            ...
            if (current < totalPages - 2) {
                ...
                html += `<button class="btn btn-sm btn-outline-primary me-1" onclick="loadCards(${totalPages}, '${searchTerm}')">${totalPages}</button>`;
            }
