            ...
            <tr>
                <td colspan="2" valign="top">
                    <table width="95%" border="0" class="baris" align="center">
                        ...
                        <tr>
                            <td>&nbsp;</td>
                            <td colspan="3"><i>(Gunakan Skor 4 = Sangat Bersih, 3 = Bersih, 2 = Cukup, 1 = Kurang)</i>
                            </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table width="90%" style="line-height: 11px" class="tabel" align="center">
                        ...
                        @foreach ($hasilKuesioner as $i => $item): ?>
                            <tr>
                                ...
                                <td align="left" style="text-align: left; padding-left: 5px">{{$item->catatan_pengawas}}
                                </td>
                            </tr>
                        @endforeach
                    </table>
            ...
            <table width="90%" style="line-height: 11px" class="tabel" align="center">
                ...
                @foreach ($hasilKuesioner as $i => $item): ?>
                    <tr>
                        ...
                        <td align="left" style="text-align: left; padding-left: 5px">{{$item->catatan_dokumentasi_pengawas}}
                        </td>
                    </tr>
                @endforeach
            </table>
