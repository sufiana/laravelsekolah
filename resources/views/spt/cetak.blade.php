            ...
            <td colspan="2">
                <div id="header">
                    <table width="100%">
                        <tr>
                            <td width="12%">
                                <img class="navbar-brand-icon" src="{{ asset('images/') }}/logo.png" width="160px" height="120px">
                            </td>
                            <td width="88%"  align="center">
                                ...
                                <span class="kop3"><?= $kop->kopsurat_baris5;?></span><br/>
                                <span class="kop3"><?= $kop->kopsurat_baris6;?></span>
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <td>
                <table width="100%" style="line-height: 11px" class="tabel" align="center">
                    <tr>
                        ...
                        <td width="35%"><b>Nama / NIP</b></td>
                        <td width="30%"><b>Pangkat/Gol <br/> Ruang</b></td>
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td width="43%">
                            <table width="100%">
                                <tr>
                                    <td colspan="2">Ditetapkan di {{$kop->tempat_ttd}}</td>
                                </tr>
                                <tr>
                                    <td width="35%">Pada Tanggal :</td>
                                    <td width="65%"><?php echo $tanggalspt; ?></td>
                                </tr>
                                <tr>
                                    <td colspan="2" align="left"><b><?=strtoupper($cetakjabatan);?></b></td>
                                </tr>
                                <tr>
                                    <td colspan="2" align="center"><br/><br/><br/></td>
                                </tr>
                                <tr>
                                    <td colspan="2" align="left"><b><?=strtoupper($namattd);?></b></td>
                                </tr>
                                <tr>
                                    <td colspan="2" align="left"><b><?=strtoupper($golongan);?></b></td>
                                </tr>
                                <tr>
                                    <td colspan="2" align="left"><b>NIP. <?=$nipttd;?></b></td>
                                </tr>
                          </table>
                        </td>
                    </tr>
