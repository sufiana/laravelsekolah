                                        ...
                                        <div class="col-12">
                                            ...
                                            <button type="button" class="btn btn-danger btn-sm col-12"
                                                onclick="window.location.href='{{ route('auth.google.redirect') }}'"> <i
                                                    class="fa fa-google me-2"></i> <span
                                                    style="padding-left: 20px">{{ __('Login by Google') }} </span></button>
                                        </div>
                                    </div>
                                    <div class="text-center my-3">
                                        <span style="font-style: italic;">Belum Terdaftar ? <a style="color: #3e5879">Klik
                                                disini untuk pendaftaran akun</a></span>
                                    </div>
