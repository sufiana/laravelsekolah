            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li><span><a href="{{ route('sekolahbersih.index') }}"><i class="fa fa-list"></i> Data
                                    @yield('title')</a></span></li>
                    ...
                    <div class="main-box clearfix profile-box-contact">
                        <div class="main-box-body clearfix">
                            <div class="profile-box-header gray-bg clearfix" style="background-color: #3e5879 !important;">
                                ...
                                <h2>{{$sekolah->nama}} {{ $kabupaten->nama_kabupaten }}</h2>
                                ...
                                <ul class="contact-details">
                                    <li>
                                        ...
                                        {{date('d-M-Y', strtotime($model->periode_awal_kuesioner)) . ' s/d ' . date('d-M-Y', strtotime($model->periode_awal_kuesioner))}}
                                    </li>
                                    <li>
                                ...
                                <a href="#" style="color: white">
                                    ...
                                    @if($model->status_verifikasi_sekolah == 1)
                                        ...
                                        <span class="label">Tanggal :
                                            {{date('d-M-Y', strtotime($model->tanggal_verifikasi))}}</span><br />
                                    @endif
                                </a>
                                <a href="#" style="color: white">
                                    <span class="value">
                                    ...
                                    @if($model->status_evaluasi_pengawas == 1)
                                        ...
                                        <span class="label">Tanggal :
                                            {{date('d-M-Y', strtotime($model->tanggal_approval_pengawas))}}</span><br />
                                    @endif
                                </a>
                                <a href="#" style="color: white">
                                    <span class="value">
