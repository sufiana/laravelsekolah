            ...
            <div class="col-lg-12">
                <div class="main-box clearfix">
                    ...
                    <div class="main-box-body clearfix">
                        ...
                        <form role="form" method="POST" action="{{ route('pegawai.simpan') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="form-group col-6">
                                    <label>NIP<span class="wajib"></span></label>
                                    <input type="text" name="nip" id="nip" class="form-control" placeholder="NIP @yield('title')" required>

                                </div>
                                <div class="form-group col-6">
                                    <label>No. Kartu Pegawai</label>
                                    <input type="text" name="no_kartu_pegawai" id="no_kartu_pegawai" placeholder="No. Kartu @yield('title')" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-6">
                                    ...
                                    <input type="text" name="nama_pegawai" id="nama_pegawai" class="form-control" placeholder="Nama @yield('title')" required>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="tanggal_lahir" name="tanggal_lahir" class="form-control datepicker" data-date-format="DD/MMM/YYYY" type="date" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input type="text" name="no_telp_wa" id="no_telp_wa" class="form-control" placeholder="No Telp Whatsapp" required>

                                    <label>No NPWP</label>
                                    <input type="text" name="no_npwp" id="no_npwp" class="form-control" placeholder="NPWP">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-6">
                                    ...
                                    <select name="agama" id="agama" class="form-control select2">
                                        ...
                                        @foreach ($agama as $ag)
                                        <option value="{{ $ag->id }}" {{(old('agama') == $ag->id?'selected':'')}}>{{$ag->nama}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group col-6">
                                    ...
                                    <select name="pendidikan_terakhir" id="pendidikan_terakhir" class="form-control select2">
                                        ...
                                        <option value="{{ $pend->id }}" {{(old('pendidikan_terakhir') == $pend->id?'selected':'')}}>{{$pend->nama}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-6">
                                    ...
                                    <select name="pangkat" id="pangkat" class="form-control select2" required>
                                        ...
                                        <option value="{{ $png->id }}" {{(old('pangkat') == $png->id?'selected':'')}}>{{$png->nama}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group col-6">
                                    ...
                                    <select name="golongan" id="golongan" class="form-control select2" required>
                                        ...
                                        <option value="{{ $gol->id }}" {{(old('golongan') == $gol->id?'selected':'')}}>{{$gol->nama}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-6">
                                    ...
                                    <select name="id_eselon" id="id_eselon" class="form-control select2" required>
                                        ...
                                        <option value="{{ $es->id }}" {{(old('id_eselon') == $es->id?'selected':'')}}>{{$es->nama}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group col-6">
                            ...
                            <div class="row">
                                <div class="form-group col-6">
                                    ...
                                    <select name="status_pegawai" id="status_pegawai" class="form-control select2" required>
                                        ...
                                        <option value="{{ $sp->id }}" {{(old('status_pegawai') == $sp->id?'selected':'')}}>{{$sp->nama}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group col-6">
