...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('assets/themes') }}/components/bootstrap/dist/css/bootstrap.min.css" />
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('assets/themes') }}/components-custom/jquery-jvectormap-2.0.3/jquery-jvectormap-2.0.3.css" />
    <link rel="stylesheet" type="text/css"
        href="{{ asset('assets/themes') }}/components/weather-icons/css/weather-icons.min.css" />
...
<body>
    ...
    <script
        src="{{ asset('assets/themes') }}/components/nanoscroller/bin/javascripts/jquery.nanoscroller.min.js"></script>
    ...
    <script
        src="{{ asset('assets/themes') }}/components-custom/jquery-jvectormap-2.0.3/jquery-jvectormap-2.0.3.min.js"></script>
    <script
        src="{{ asset('assets/themes') }}/components-custom/jvectormap-maps/jquery-jvectormap-world-merc.js"></script>
