            ...
            <div class="col-lg-12">
                <div class="main-box clearfix">
                    ...
                    <div class="main-box-body clearfix">
                        ...
                        <form role="form" method="POST" action="{{ route('biaya.update') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="form-group col-6">
                                    ...
                                    <select name="jabatan" id="jabatan" class="form-control select2" required>
                                        ...
                                        <option value="{{ $png->id }}" {{(old('jabatan' ,$model->jabatan) == $png->id?'selected':'')}}>{{$png->kode.' - '.$png->nama}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group col-6">
                                    ...
                                    <select name="jenis_biaya" id="jenis_biaya" class="form-control select2" required>
                                        ...
                                        <option value="{{ $j->id }}" {{(old('jenis_biaya',$model->jenis_biaya) == $j->id?'selected':'')}}>{{$j->nama}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-6">
                                    ...
                                    <textarea class="form-control" id="deskripsi" name="deskripsi" rows="4">{{$model->deskripsi}}</textarea>
                                </div>
                                <div class="form-group col-6">
                                    ...
                                    <select name="status_wilayah_biaya" id="status_wilayah_biaya" class="form-control select2" required>
                                        ...
                                        <option value="{{ $s->id }}" {{(old('status_wilayah_biaya',$model->status_wilayah_biaya) == $s->id?'selected':'')}}>{{$s->nama}}</option>
                                        @endforeach
                                    </select>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="nominal" name="nominal" value="{{old('nominal',number_format($model->nominal, 0, ',', '.'))}}" required>
                                    </div>
                                </div>
                            </div>
